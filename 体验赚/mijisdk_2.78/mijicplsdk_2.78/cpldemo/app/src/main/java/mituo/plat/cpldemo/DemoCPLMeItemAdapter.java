...
public class DemoCPLMeItemAdapter extends BaseAdapter {
    ...
    static class ViewHolder {
        ...
        public HtmlTextView tvDoneCount;

        public HtmlTextView tvSize;

        public TextView tvTaward;
    ...
    /** 构造方法 **/
    public DemoCPLMeItemAdapter(Activity cont) {
        context = cont;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = lif.inflate(R.layout.demo_cpl_me_item_new, null);
            ...
            views.tvDoneCount =  (HtmlTextView)convertView.findViewById(R.id.demo_done_count);
            views.tvSize =  (HtmlTextView)convertView.findViewById(R.id.demo_app_size);
            views.tvTaward = (TextView)convertView.findViewById(R.id.demo_taward);
        ...
        views.tvDoneCount.setHtml(item.getDoneCount(),new HtmlHttpImageGetter(views.tvDoneCount));

        String ready = "总奖励" + MituoUtil.miText2(item.getTotalAward());
        views.tvTaward.setText(ready);

        views.tvStatus.setText(MituoUtil.miText2(item.getEaward()));
